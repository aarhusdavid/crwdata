...
#     def __init__(self, id, first_name, last_name, email, password, parent_location_id=None, role=None, last_login=None):
#         self.id = id
...
#     id = db.Column(db.String, primary_key=True)
#     user_id = db.Column(db.String, db.ForeignKey('cd_user.id'), nullable=True)
...
#     id = db.Column(db.String, primary_key=True)
#     parent_location_id = db.Column(db.String, db.ForeignKey('cd_parent_location.id'), nullable=True)
#     name = db.Column(db.String, nullable=True)
#     type = db.Column(db.String, nullable=True)
#     date_established = db.Column(db.Date, nullable=True)
#     street_address_one = db.Column(db.String, nullable=True)
